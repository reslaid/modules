...
class Ai(Module):
    ...
    def handle(self):
        ...
        async def translate(event):
            ...
            translated = await self.translate(text, args[1], args[0])
            await event.delete()
